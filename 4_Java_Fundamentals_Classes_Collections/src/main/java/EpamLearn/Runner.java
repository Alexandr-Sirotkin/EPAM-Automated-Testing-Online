...
public class Runner {
  ...
  static List<? extends Car> cars = Arrays.asList(
      new PassengerCar("BMW", "3 series", 2010, 240, 8.9, 10_000, Species.PASSENGER_CAR, CarBodyType.SEDAN),
      new PassengerCar("Mazda", "6", 2018, 207, 8.4, 24_500, Species.PASSENGER_CAR, CarBodyType.SEDAN),
      new PassengerCar("Lexus", "LS", 2015, 250, 13.1, 52_000, Species.PASSENGER_CAR, CarBodyType.SEDAN),
      new PassengerCar("Volkswagen", "Touareg", 2015, 220, 10.9, 27_500, Species.PASSENGER_CAR, CarBodyType.SUV),
      new PassengerCar("BMW", "1 series", 2018, 204, 7.6, 16_000, Species.PASSENGER_CAR, CarBodyType.HATCHBACK),
      new PassengerCar("Ford", "Mustang", 2016, 233, 12.2, 26_800, Species.PASSENGER_CAR, CarBodyType.COUPE),
      new PassengerCar("Audi", "A6", 2014, 250, 8.3, 23_800, Species.PASSENGER_CAR, CarBodyType.STATION_WAGON),
      new PassengerCar("Mercedes-Benz", "SLC-Class", 2016, 250, 10.7, 36_500, Species.PASSENGER_CAR, CarBodyType.CABRIOLET),
      ...
      new Truck("MAN", "TGS", 2013, 100, 32.6, 104_900, Species.TRUCK, TruckBodyType.EIGHTEEN_WHEELER)
  );
